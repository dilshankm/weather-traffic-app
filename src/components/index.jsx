  ...
  const Main = () => {
    ...
    let { traficImages, loadingTraficImages } = useFetchTraficImages(date, time);
    const [disableClose, setDisableClose] = useState(null);
    let { weatherForecast, loadingWeatherForecast } = useFetchWeatherForecast(
      date,
      time
    );
